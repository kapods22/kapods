...
async function fetchRSS(podcast) {
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    let episodeInfo = {
      ...
      showNotes: item.querySelector("description").innerHTML.replace("<![CDATA[", "").replace("]]>", "").replace("______________________</p>", '</p><hr class="block">').gReplaceAll("<p>", '<p class="block">').gReplaceAll("<ul>", '<ul class="block">').gReplaceAll("<ol>", '<ol class="block">').gReplaceAll("<a ", '<a target="_blank" ').gReplaceAll('<a target="_blank" href=\'https://kingdomanimaliapod.com', '<a target="_self" href=\'https://kingdomanimaliapod.com').gReplaceAll('<a target="_blank" href="https://kingdomanimaliapod.com', '<a target="_self" href="https://kingdomanimaliapod.com').gReplaceAll('<a target="_blank" href=\'https://www.kingdomanimaliapod.com', '<a target="_self" href=\'https://www.kingdomanimaliapod.com').gReplaceAll('<a target="_blank" href="https://www.kingdomanimaliapod.com', '<a target="_self" href="https://www.kingdomanimaliapod.com').replace(showNotesWebsite, "").replace('<p class="block"><a target="_blank" rel="payment" href="https://kingdomanimaliapod.com/support">Support the show</a></p>', "").replace("<p class=\"block\">This podcast is made by <a target=\"_self\" href='https://www.kingdomanimaliapod.com/'>Kingdom: Animalia Podcasts</a>.</p>", ""),
      date: {
